 ...
 * @author baltzell
 */
public class EBTBEngine_OC extends EBEngine {
    ...
    public EBTBEngine_OC(){
        super("EBTB_OC");
        setUsePOCA(false);
        setEcalClustersType("ECAL::clusters_OC");
        setEcalMomentsType("ECAL::moments_OC");
        setEcalCalibType("ECAL::calib_OC");
    }
